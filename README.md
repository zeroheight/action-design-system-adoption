...
**Check out [our example React application](https://github.com/zh-ski/example-airorange-app) for reference and [it's containing GitHub Action file](https://github.com/zh-ski/example-airorange-app/blob/master/.github/workflows/deploy.yaml).**
